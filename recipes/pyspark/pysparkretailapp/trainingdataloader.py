...
def load(configProperties, spark):
    ...
    dataset_id = str(configProperties.get("dataSetId"))
    api_key = str(configProperties.get("api_key"))
    timeframe = str(configProperties.get("timeframe"))
    batch_id = str(configProperties.get("batchId"))
    ...
    # Split the data
    if timeframe != 'None' :
      print("Total number of rows before filtering : " + str(pd.count()))
      ...
      print("Total number of rows after filtering : " + str(train.count()))
    else :
